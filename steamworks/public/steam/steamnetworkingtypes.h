...
struct SteamNetworkingConfigValue_t
{
	...
	// ZIG: 	int32_t m_int32;
		int64_t m_int64;
	// ZIG: 	float m_float;
	// ZIG: 	const char *m_string; // Points to your '\0'-terminated buffer
	// ZIG: 	void *m_ptr;
	// ZIG: } m_val;
	...
	//
	// ZIG: inline void SetInt32( ESteamNetworkingConfigValue eVal, int32_t data )
	// ZIG:{
	// ZIG:	m_eValue = eVal;
	// ZIG:	m_eDataType = k_ESteamNetworkingConfig_Int32;
	// ZIG:	m_val.m_int32 = data;
	// ZIG:}
	...
	// ZIG:inline void SetFloat( ESteamNetworkingConfigValue eVal, float data )
	// ZIG:{
	// ZIG:	m_eValue = eVal;
	// ZIG:	m_eDataType = k_ESteamNetworkingConfig_Float;
	// ZIG:	m_val.m_float = data;
	// ZIG:}
	// ZIG:inline void SetPtr( ESteamNetworkingConfigValue eVal, void *data )
	// ZIG:{
	// ZIG:	m_eValue = eVal;
	// ZIG:	m_eDataType = k_ESteamNetworkingConfig_Ptr;
	// ZIG:	m_val.m_ptr = data;
	// ZIG:}
	// ZIG:inline void SetString( ESteamNetworkingConfigValue eVal, const char *data ) // WARNING - Just saves your pointer.  Does NOT make a copy of the string
	// ZIG:{
	// ZIG:	m_eValue = eVal;
	// ZIG:	m_eDataType = k_ESteamNetworkingConfig_Ptr;
	// ZIG:	m_val.m_string = data;
	// ZIG:}
};
