...
pub const PS3TrophiesInstalled_t = extern struct {
    m_nGameID: uint64 = 0,
    m_eResult: EResult = EResult.k_EResultNone,
    m_ulRequiredDiskSpace: uint64 = 0,
};
/// callbackId = 1112
...
pub const SteamInputActionEvent_t = extern struct {
    ...
    analogAction: SteamInputActionEvent_t,
};
...
pub const ISteamNetworkingSockets = extern struct {
    ...
    pub fn GetCertificateRequest(self: Self, pcbBlob: [*c]i32, pBlob: ?*anyopaque, errMsg: SteamNetworkingErrMsg) bool {
        return SteamAPI_ISteamNetworkingSockets_GetCertificateRequest(self.ptr, pcbBlob, pBlob, errMsg);
    }

    pub fn SetCertificate(self: Self, pCertificate: ?*const anyopaque, cbCertificate: i32, errMsg: SteamNetworkingErrMsg) bool {
...
extern fn SteamAPI_ISteamNetworkingSockets_GetCertificateRequest(self: ?*anyopaque, pcbBlob: [*c]i32, pBlob: ?*anyopaque, errMsg: SteamNetworkingErrMsg) callconv(.C) bool;
extern fn SteamAPI_ISteamNetworkingSockets_SetCertificate(self: ?*anyopaque, pCertificate: ?*const anyopaque, cbCertificate: i32, errMsg: SteamNetworkingErrMsg) callconv(.C) bool;
