    ...
    if (struct_info.layout == .Extern) {
        ...
        inline for (struct_info.fields) |field| {
            if (!field.is_comptime) {
                ...
                if (end > slice.len) @panic("not enough data");
...
pub const ClientGameServerDeny_t = extern struct {
    m_uAppID: uint32 align(1) = 0,
    m_unGameServerIP: uint32 align(1) = 0,
    m_usGameServerPort: uint16 align(1) = 0,
    m_bSecure: uint16 align(1) = 0,
    m_uReason: uint32 align(1) = 0,
};
/// callbackId = 117
...
pub const GameOverlayActivated_t = extern struct {
    m_bActive: uint8 align(2) = 0,
    m_bUserInitiated: bool align(2) = false,
    m_nAppID: AppId_t align(2) = 0,
};
/// callbackId = 332
...
pub const SteamInputConfigurationLoaded_t = extern struct {
    m_unAppID: AppId_t align(2) = 0,
    m_ulDeviceHandle: InputHandle_t align(2) = 0,
    m_ulMappingCreator: CSteamID align(2),
    m_unMajorRevision: uint32 align(2) = 0,
    m_unMinorRevision: uint32 align(2) = 0,
    m_bUsesSteamInputAPI: bool align(2) = false,
    m_bUsesGamepadAPI: bool align(2) = false,
};
/// callbackId = 2804
