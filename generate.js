...
out.push(`pub const StructPlatformPackSize = 4;`)
out.push(`pub const StructPackSize = 1;`)
...
function printStruct(struct) {
  ...
  struct.fields.forEach(_ => {
    ...
    const alignment = structName in g_CustomPackSize ? `align(${g_CustomPackSize[structName]})` : `align(StructPlatformPackSize)`; // https://github.com/ziglang/zig/issues/16633
